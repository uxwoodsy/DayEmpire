...
const Benefits = () => {
  return (
    <>
    <div className="border-t-1 mx-8 pt-20 sm:pt-0 sm:mx-16 border-gray-200">
       <div className="mx-auto max-w-7xl px-8 sm:px-6 lg:px-8 pb-10 text-center lg:pt-32 lg:pb-16 relative">
      ...
      <div className="mx-auto max-w-7xl text-center px-8 sm:px-6 lg:mb-32">
