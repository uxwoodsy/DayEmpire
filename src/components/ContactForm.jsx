...
const ContactForm = () => { 
    ...
    <div id='SellCards' className="relative flex mx-8 sm:mx-16 sm:justify-center">
      <div className="hidden lg:inline absolute -left-50 top-0"><img src='/large-pikachu-tilt.png' className="w-0 lg:w-[400px] xl:w-[500px] 2xl:w-[600px]"  alt='Image shows a Pikachu Pokemon card'/></div>
